...
var EntityRolePanel = React.createClass({

  mixins: [LinkedStateMixin],

  getStateFromStores() {
  	console.log("GETSTATE");
    var ce = EntityRoleStore.getByID(this.props.params.id);
    console.log("GETSTATE",ce);
    return {
      currentEntity: ce,
  ...
  handleDeleteClick: function() {
    ...
    ServerActionCreator.deleteEntityRole(this.state.currentEntity.id);
  ...
  handleCancelClick: function() {
    ...
    this.setState({
      currentEntity: EntityRoleStore.getByID(this.props.id),
      edited: false
    });
    this._onChange();
  },
  ...
  handleSaveClick: function() {;
    ...
    var formData = {
      ...
      name: $('#updateEntityRoleForm-name').val(),
      description: $('#updateEntityRoleForm-description').val()
    };

    if (formData.name && formData.description) {
      ServerActionCreator.editEntityRole(JSON.stringify(formData));
    }
  ...
  render: function() {
  	console.log(this.state.currentEntity.id);
    if (this.state.currentEntity.id !== undefined) {
      return (
      	<div className="panel-body">
	      <div className="row">
	        <div>
	          <form className="form-horizontal" id="updateEntityRoleForm" name="updateEntityRoleForm">
	            <div className="row">
	              ...
	              <div className="panel panel-default">
	                ...
	                <div className="form-group">
	                  <label className="col-sm-4 control-label" htmlFor="updateEntityRoleForm-name">Name:</label>
	                  <div className="col-sm-8">
	                    <input type="text" id="updateEntityRoleForm-name" className="form-control" valueLink={this.makeValueLink('name')} required />
	                  </div>
	                </div>

	                <div className="form-group">
	                  <label className="col-sm-4 control-label" htmlFor="updateEntityRoleForm-description">Description:</label>
	                  <div className="col-sm-8">
	                    <input type="text" id="updateEntityRoleForm-description" className="form-control" valueLink={this.makeValueLink('description')} />
	                  </div>
	                </div>
	                </div>
	              </div>
...
export default EntityRolePanel;
