/*/**
 * Mocha tests for API:  "/api/entities"
 *
...
describe('*** Entities APIs:', function () {
  var token , email, signid
  ...
  describe('GET (by id given)'+endpoint, function () {
  ...
  describe('PUT '+endpoint, function () {
    ...
    var entityEdit = {
      id : id,
      idnumber: mock.entity.idnumber,
      name:"deepaka",
      dba:mock.entity.dba,
      individual:true,
      data:{
      phone: mock.entity.phone,
      email: mock.entity.email,
      password: mock.entity.password,
      website: mock.entity.website
      }
    }
      server
        .put(endpoint)
